    ...
    return (<div>
        ...
        <div class="container">
            <div class="item item1">
                ...
                <p class="description">Briefly describe the actual event leading leading to the unpleasant emotion</p>
                <textarea rows="4" autofocus name="situation" form="usrform" id="situation"></textarea>
            </div>
            <div class="item item2">
                <p class="title">Emotion(s)</p>
                <p class="description">1. Specify sad/anxious/angry, etc. <br/>2. Rate degree of emotion, 1-100%.</p>
